...
final ThemeData petParkTheme = ThemeData(
  fontFamily: FONT_FAMILY,
  brightness: Brightness.light,
  primaryColor: colorSchemeLight.customPurple,
  ...
  appBarTheme: _appBarTheme(),
  cardColor: colorSchemeLight.customLightGrey,
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    selectedItemColor: colorSchemeLight.customPurple,
    unselectedItemColor: colorSchemeLight.customGrey,
  ...
  unselectedWidgetColor: colorSchemeLight.customGrey,
  ...
  floatingActionButtonTheme: FloatingActionButtonThemeData(
    backgroundColor: colorSchemeLight.customPurple,
    iconSize: 30,
  ),
